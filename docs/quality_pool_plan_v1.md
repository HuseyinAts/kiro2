...
| 1.5 | ✅ **Post-fix audit (TAMAMLANDI 15 May)** | 30 random sample. Missing_diagram %30.05 (hedef <%5 SAĞLANMADI — pipeline-fix limit). 49,313 → 14,817 (%70 düşüş). %77 VALID_QNO no_match → ocr_crops eksik/disk crop yok. RESULT: `_pilots/20260515_post_fix_audit_RESULT.md`. Hedef revize: pipeline-fix tek başına yeterli değil, Faz 1.10 Re-OCR + Faz 3 Curator gerek. |
