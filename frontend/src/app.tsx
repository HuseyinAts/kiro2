...
import { PWAInstallButton, OfflineIndicator } from './components/PWAStatus'
...
// Pages - Auth (loaded first, keep eager for faster login)
...
function AppContent() {
  useEffect(() => {
    ...
    initWebVitals().catch(() => {
      ...
      console.info('[Web Vitals] Using fallback implementation')
