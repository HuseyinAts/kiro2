/**
 * Basic Results Tab Component
 *
 * Displays basic exam statistics, charts, and detailed topic analysis
 * Refactored from AdvancedExamResults.tsx
 */
...
import { preparePieChartData, prepareTopicPerformanceData } from '../../../../utils/examResultsHelpers';

export interface BasicResultsTabProps {
  sonuc: SinavSonucu
}
