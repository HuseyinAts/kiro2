 ...
 * Header section for Learning Path page
 */
        ...
        >
          ...
          >
            <Typography variant="body2">
              <strong>💡 İpucu:</strong> Görsel öğrenme stilinize uygun videolar ve diyagramlar önceliklendirildi.
              Karmaşık konuları anlamak için görsel kaynakları tercih edin!
            </Typography>
          </Alert>
        </Paper>
      )}
