...
//
// ⚠️ Sunucu-otoriter kurallar (mock'ta simüle edilir, live'da sunucu yapar):
...
import type {
  ...
  ReviewItem, LastExam, Question, CatItem, SeviyeBilgi, SubjectKey, KiroData,
  KatalogKey,
  Odev,
  SinifOgrenci,
  AuthTokens,
...
// durum: 'bekliyor' geciken demektir — UI'da asla "eksik" yazılmaz (kaygı-duyarlı)
// ---------------------------------------------------------------------------
