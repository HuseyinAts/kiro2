// ============================================================================
// KIRO2 — kiro-seed.js  (OTOMATİK ÜRETİLDİ — elle düzenleme)
// kiro-data.js'in SENKRON ikizi: <head>'de klasik <script> olarak yüklenir,
// support.js'ten ÖNCE çalışır → window.__KIRO ilk render'dan önce hazırdır.
// kiro-data.js değişince bu dosyayı YENİDEN ÜRET.
// ============================================================================
(function () {
// ============================================================================
...
const subjectMap = subjects.reduce((m, s) => { m[s.key] = s; return m; }, {});
...
const seviyeEsik = [0, 0, 200, 450, 760, 1140, 1580, 2080, 2680, 3380, 4180, 5080, 6080];

// Bir XP değerinin seviye bilgisi: seviye + sonraki seviyeye ilerleme (Lig level-up için)
function seviyeBilgi(xp) {
  let sev = 1;
...
function bugunBilgi(d = new Date()) {
...
window.__KIRO = { engine, persona, subjects, subjectMap, topics, dersKatalog, alanlar, katalogKonular, katalogUniteler, sinifRoster, reviewQueue, lastExam, questionBank, flashcards, catBankMat, curriculum, atomKirilim, enZayifAtom, atomlarByKonu, masteryTier, irtProb, seciliSet, konularByDers, trNum, seviyeEsik, seviyeBilgi, bugunBilgi, buHafta, odevler };
})();
