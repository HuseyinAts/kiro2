...
class SmartRouter:
    ...
    def analyze_complexity(self, query: str, context: Optional[Dict] = None) -> int:
        """
    ...
    def route(self, query: str, context: Optional[Dict] = None) -> ModelType:
        ...
        elif complexity <= self.complexity_thresholds[ComplexityLevel.MEDIUM]:
            return ModelType.GEMINI_ASSIST
        else:
            return ModelType.GEMINI_THINKING
    
    def get_routing_info(self, query: str, context: Optional[Dict] = None) -> Dict:
