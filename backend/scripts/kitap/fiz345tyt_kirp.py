#!/usr/bin/env python
"""345 2025 TYT Fizik: kirpim kutularindan soru gorselleri uretir (prg345_kirp deseni).

Gorseller git'e girmez; her kutu `345_2025_tyt_fizik_kirpim_kutulari.json`
...
KULLANIM
--------
    python backend/scripts/kitap/fiz345tyt_kirp.py
    python backend/scripts/kitap/fiz345tyt_kirp.py --ornek 40
    python backend/scripts/kitap/fiz345tyt_kirp.py --cikti <dizin> --rapor <json>
"""
...
def main() -> None:
    ...
    ap.add_argument(
        "--cikti", default=str(KOK / "backend" / "_p345_gecici" / "tf" / "kirpim")
    )
    ap.add_argument(
        "--rapor",
        default=str(CIKTI / "345_2025_tyt_fizik_ortme_olcumu.json"),
    ...
    if args.rapor:
        rapor = {
            ...
            "arac": "scripts/kitap/fiz345tyt_kirp.py",
            "ne_olculdu": (
