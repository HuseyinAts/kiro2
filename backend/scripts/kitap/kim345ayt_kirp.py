#!/usr/bin/env python
"""345 2025 AYT Kimya: kirpim kutularindan soru gorselleri uretir.

Gorseller git'e girmez; her kutu `345_2025_ayt_kimya_kirpim_kutulari.json`
...
KULLANIM
--------
    python backend/scripts/kitap/kim345ayt_kirp.py
    python backend/scripts/kitap/kim345ayt_kirp.py --ornek 40
    python backend/scripts/kitap/kim345ayt_kirp.py --cikti <dizin> --rapor <json>
"""
...
from kim345ayt_tarama import cerceve_maskesi, kart, kaynak_dizin
...
def main() -> None:
    ...
    ap.add_argument(
        "--cikti", default=str(KOK / "backend" / "_k345_gecici" / "k_kirpim")
    )
    ap.add_argument(
        "--rapor",
        default=str(CIKTI / "345_2025_ayt_kimya_ortme_olcumu.json"),
    ...
    if args.rapor:
        rapor = {
            ...
            "arac": "scripts/kitap/kim345ayt_kirp.py",
            "ne_olculdu": (
