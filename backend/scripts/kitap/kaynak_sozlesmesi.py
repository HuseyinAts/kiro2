...
KAYNAK_KAYITLARI: dict[str, dict[str, str]] = {
    ...
    "Aktif Ogrenme Tyt Dilbilgisi Soru Bankasi 2025": {
        "onek": "AKTIF_DILBILGISI",
        "ithal_araci": "scripts/kitap/dilbilgisi_ithal.py",
    },
    "Bilgi Sarmal Tyt Turkce Soru Bankasi": {
        "onek": "BS_TYT_TURKCE",
    ...
    "Orijinal 2024 TYT-AYT Geometri Soru Bankasi": {
    ...
    "345 2025 AYT Turk Edebiyati Soru Bankasi": {
        "onek": "EDB345AYT",
    ...
    "345 2025 Start Matematik": {
        "onek": "STM345",
        "ithal_araci": "scripts/kitap/stm345_ithal.py",
    },
    "345 2025 TYT Fizik Soru Bankasi": {
        "onek": "FZT345",
