#!/usr/bin/env python
"""Mikro Orijinal TYT Fizik veri setindeki kutulardan soru gorsellerini uretir.
...
gorseller PDF'ten her ortamda YENIDEN uretilebilir. mikro_geo_kirp.py ile
ayni desen.

KOORDINAT SISTEMI -- DIKKAT
---------------------------
`kirpim_kutusu` SAYFA KARTI koordinatlarindadir (kart = tam goruntunun
icindeki (596, 46)-(1324, 1014) dikdortgeni). PDF sayfasi ise 1920x1080
...
Uretilen dosya adi question_content.question_image_url ile birebir ayni:
    ...
    <CROP_IMAGE_DIR>/MIKRO_FIZIK_TYT/<kayit_id>.png

KULLANIM
--------
    python backend/scripts/kitap/mikro_fizik_kirp.py [--olcek 1.0]
"""
...
PDF_DESENI = "veriseti/zkitap/screenshots/Mikro Orijinal Tyt Fizik*/*.pdf"
