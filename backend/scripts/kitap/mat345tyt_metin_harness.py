#!/usr/bin/env python
"""345 2025 TYT Matematik: transkripsiyon harness'i (hazirla / topla / kapi).
...
---------------------------------------
1. Her kirpim tam bir kez okunmus olmali (2063 dosya, eksik/fazla yok).
...
4. Toplam soru sayisi 2063.

KULLANIM
--------
    python backend/scripts/kitap/mat345tyt_metin_harness.py hazirla
    python backend/scripts/kitap/mat345tyt_metin_harness.py topla
    python backend/scripts/kitap/mat345tyt_metin_harness.py kapi
"""
...
KUTULAR = CIKTI / "345_2025_tyt_matematik_kirpim_kutulari.json"
HEDEF = CIKTI / "345_2025_tyt_matematik_metin.json"
KIRPIM = KOK / "backend" / "_mat_gecici" / "m_kirpim"
OKUMA_KOKU = Path(r"C:\Users\husey\VeraFilm\m_okuma_kirpim")
PARCA_DIZINI = Path(r"C:\Users\husey\VeraFilm\m_metin_parca")
BEKLENEN_SORU = 2063
GRUP_SORU = 60
OLCEK = 2
        ...
        json.dumps(
            {
                ...
                "nereden": (
                    "Soru kirpimlarindan okundu (mat345tyt_kirp.py, 2x Lanczos). Sorular "
