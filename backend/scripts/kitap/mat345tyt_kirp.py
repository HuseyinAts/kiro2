#!/usr/bin/env python
"""345 2025 TYT Matematik: kirpim kutularindan soru gorselleri uretir.

Gorseller git'e girmez; her kutu `345_2025_tyt_matematik_kirpim_kutulari.json`
...
KULLANIM
--------
    python backend/scripts/kitap/mat345tyt_kirp.py
    python backend/scripts/kitap/mat345tyt_kirp.py --ornek 40
    python backend/scripts/kitap/mat345tyt_kirp.py --cikti <dizin> --rapor <json>
"""
...
from mat345tyt_tarama import cerceve_maskesi, kart, kaynak_dizin
...
def main() -> None:
    ...
    ap.add_argument(
        "--cikti", default=str(KOK / "backend" / "_mat_gecici" / "m_kirpim")
    )
    ap.add_argument(
        "--rapor",
        default=str(CIKTI / "345_2025_tyt_matematik_ortme_olcumu.json"),
    ...
    if args.rapor:
        rapor = {
            ...
            "arac": "scripts/kitap/mat345tyt_kirp.py",
            "ne_olculdu": (
