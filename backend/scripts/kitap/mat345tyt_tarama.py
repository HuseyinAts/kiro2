#!/usr/bin/env python
"""345 2025 TYT Matematik: capa taramasi (okuyucu simgesi + basili soru numarasi + ara cizgi).
...
(`mat345tyt_kutu.py`). Bu script yalniz olcer, karar vermez.
...
KULLANIM
--------
    python backend/scripts/kitap/mat345tyt_tarama.py
"""
...
HEDEF = CIKTI / "345_2025_tyt_matematik_capa_taramasi.json"
...
def kaynak_dizin() -> Path:
    ...
    adaylar = [
        ...
        if p.is_dir() and p.name.startswith("345 2025 Tyt Matematik Soru Bankas")
    ]
    if len(adaylar) != 1:
...
def main() -> None:
    ...
    veri = {
        ...
        "arac": "scripts/kitap/mat345tyt_tarama.py",
        "kart": list(KART),
