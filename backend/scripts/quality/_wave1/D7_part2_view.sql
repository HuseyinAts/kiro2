-- D7: v_safe_for_beta'ya wave1_run provenance bayragini ekler.
-- Body = canli D6 tanimi (pg_get_viewdef 2026-06-19) birebir kopyasi;
-- SADECE bayrak-grubu parantezi icine "OR ? 'wave1_run'" eklendi.
-- gate2c_demoted exclusion (son AND) DOKUNULMADI.
-- question_bank'a yazma YOK. Rollback: D7_rollback.sql (D6 tanimina geri doner).
