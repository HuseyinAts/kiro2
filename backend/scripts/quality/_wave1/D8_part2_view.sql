-- D8: tier1 match_tier kapisini verified_provisional (kor-dogrulanmis) sorular icin gevset.
-- Kanit: 72-soru blind validation %100 precision (3 Opus solver, STEM dahil).
-- gate2c/fallback/demote/status DOKUNULMADI. question_bank'a yazma YOK. Rollback: D8_rollback.sql.
