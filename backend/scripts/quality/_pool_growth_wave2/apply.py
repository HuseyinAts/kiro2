"""Wave-2 apply: classify blind-solver predictions vs DB answer key, flag pool.
...
BASE = Path("C:/Users/husey/kiro2/backend/scripts/quality/_pool_growth_wave2")
MASTER = BASE / "master.csv"
PREDS_GLOB = str(BASE / "batches" / "preds_*.json")
APPLY_SQL = BASE / "apply.sql"
RUN_TAG = "2026_06_04_wave2"
BACKUP_TABLE = "question_bank_pool_growth_wave2_backup_20260604"
MIN_CONF = 0.6
...
print(f"=== WAVE-2 CLASSIFICATION (mode={mode}) ===")
print(
