"""Wave-4 apply: classify blind-solver predictions vs DB answer key, flag pool.

Usage:
  python apply.py            # dry-run
  python apply.py apply      # backup + apply metadata flags via psql

Invariants: correct_answer / is_active / quality_review_status NEVER touched.
...
BASE = Path("C:/Users/husey/kiro2/backend/scripts/quality/_pool_growth_wave4")
MASTER = BASE / "master.csv"
PREDS_GLOB = str(BASE / "batches" / "preds_*.json")
APPLY_SQL = BASE / "apply.sql"
RUN_TAG = "2026_06_04_wave4"
BACKUP_TABLE = "question_bank_pool_growth_wave4_backup_20260604"
MIN_CONF = 0.6
...
print(f"=== WAVE-4 CLASSIFICATION (mode={mode}) ===")
print(
