"""Wave-3 apply: classify blind-solver predictions vs DB answer key, flag pool.
...
RUN_TAG = "2026_06_04_wave3"
BACKUP_TABLE = "question_bank_pool_growth_wave3_backup_20260604"
MIN_CONF = 0.6
...
print(f"=== WAVE-3 CLASSIFICATION (mode={mode}) ===")
print(
