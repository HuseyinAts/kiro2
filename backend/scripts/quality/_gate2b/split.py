"""Gate2b splitter: all student_coherent served -> answer-free batches for gemma3.
Single-model coherence gate (gemma3 UNSOLVABLE = figure/broken). No move step;
preds stay in batches/ so chunked resume is robust."""
