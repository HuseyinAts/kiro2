-- D6 part2: v_safe_for_beta'ya gate2c_demoted exclusion ekler.
-- Body = canlı D5 tanımının birebir kopyası; SADECE son AND eklendi.
-- question_bank'a yazma YOK. Rollback: D6_rollback.sql.
