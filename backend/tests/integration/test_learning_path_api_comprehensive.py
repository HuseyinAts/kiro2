...
class TestStudentProfileCreation:
    ...
    async def test_create_profile_success(
        self, async_client: AsyncClient, authenticated_student
    ):
        ...
        response = await async_client.post(
            "/api/v1/learning-path/create-profile", json=profile_data, headers=headers
        )
    ...
    async def test_create_profile_without_auth(self, async_client: AsyncClient):
        ...
        response = await async_client.post(
            "/api/v1/learning-path/create-profile", json=profile_data
        )
...
class TestProfileRetrieval:
    ...
    async def test_get_profile_success(
        ...
        response = await async_client.get(
            f"/api/v1/learning-path/profile/{student_id}", headers=headers
        )
    ...
    async def test_get_nonexistent_profile(
        ...
        response = await async_client.get(
            f"/api/v1/learning-path/profile/{fake_student_id}", headers=headers
        )
...
class TestLearningPathCreation:
    ...
    async def test_create_learning_path_success(
        ...
        response = await async_client.post(
            "/api/v1/learning-path/create-path", json=path_data, headers=headers
        )
        ...
        assert data["learning_path"]["subject"].lower() in [
            "matematik",
            "matematık",
            "matematik".lower(),
            "matematık".lower(),
...
class TestProgressTracking:
    ...
    async def test_update_progress_success(
        ...
        # Update progress
        progress_data = {"progress": 100, "completed": True, "time_spent": 45}
...
class TestCompletionTracking:
    ...
    async def test_get_completion_status(
        ...
        # Get completion
        response = await async_client.get(
            f"/api/v1/learning-path/completion/{student_id}", headers=headers
        )
...
class TestQuizSubmission:
    ...
    async def test_submit_quiz_success(
        ...
        profile_res = await async_client.get(
            "/api/v1/learning-path/my-profile", headers=headers
        )
...
class TestResourceSearch:
    ...
    async def test_search_resources_with_fallback(
        ...
        response = await async_client.post(
            "/api/v1/learning-path/search-resources", json=search_data, headers=headers
        )
...
class TestCompleteLearningPathFlow:
    ...
    async def test_full_learning_journey(
        ...
        paths_response = await async_client.get(
            f"/api/v1/learning-path/paths/{student_id}", headers=headers
        )
