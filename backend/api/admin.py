...
async def dashboard_istatistikleri(_: Kullanici = Depends(admin_kullanici_getir)):
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"İstatistikler alınırken hata: {str(e)}",
        )
...
async def soru_bankasi_listesi(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Soru listesi alınırken hata: {str(e)}",
        )
...
async def soru_ekle(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Soru eklenirken hata: {str(e)}",
        )
...
async def soru_guncelle(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Soru güncellenirken hata: {str(e)}",
        )
...
async def soru_sil(soru_id: str, _: Kullanici = Depends(admin_kullanici_getir)):
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Soru silinirken hata: {str(e)}",
        )
...
async def egitim_materyalleri_listesi(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Eğitim materyalleri alınırken hata: {str(e)}",
        )
...
async def egitim_materyali_ekle(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Eğitim materyali eklenirken hata: {str(e)}",
        )
...
async def egitim_materyali_guncelle(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Eğitim materyali güncellenirken hata: {str(e)}",
        )
...
async def egitim_materyali_sil(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Eğitim materyali silinirken hata: {str(e)}",
        )
...
async def egitim_materyali_onayla(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Onay durumu güncellenirken hata: {str(e)}",
        )
...
async def toplu_soru_yukle(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Toplu soru yükleme hatası: {str(e)}",
        )
...
async def icerik_ara(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Arama yapılırken hata: {str(e)}",
        )
