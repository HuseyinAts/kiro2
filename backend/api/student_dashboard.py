...
async def sinav_gecmisi_getir(
    ...
    **SPRINT 2**: Multi-layer cache (L1+L2) - 10 min TTL
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Sınav geçmişi alınırken hata oluştu: {str(e)}",
        )
...
async def performans_trendi_getir(
    ...
    **SPRINT 2**: Multi-layer cache (L1+L2) - 10 min TTL
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Performans trendi alınırken hata oluştu: {str(e)}",
        )
...
async def hedefler_getir(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Hedefler alınırken hata oluştu: {str(e)}",
        )
...
async def hedef_olustur(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Hedef oluşturulurken hata oluştu: {str(e)}",
        )
...
async def hedef_guncelle(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Hedef güncellenirken hata oluştu: {str(e)}",
        )
...
async def hedef_sil(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Hedef silinirken hata oluştu: {str(e)}",
        )
...
async def ogrenci_profili_getir(
    ...
    **SPRINT 2**: Multi-layer cache (L1+L2) - 30 min TTL
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Profil alınırken hata oluştu: {str(e)}",
        )
...
async def dashboard_ozeti(
    ...
    **SPRINT 2**: Multi-layer cache (L1+L2) - 3 min TTL
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Dashboard özeti alınırken hata oluştu: {str(e)}",
        )
