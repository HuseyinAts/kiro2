...
def verify_coppa_consent(
    ...
    consent = (
        db.query(COPPAParentalConsent)
        .filter(COPPAParentalConsent.consent_id == consent_id)
        .first()
    )
...
def get_coppa_consent_status(
    ...
    consent = (
        db.query(COPPAParentalConsent)
        .filter(COPPAParentalConsent.child_id == child_id)
...
def get_ferpa_access_log(
    ...
    access_logs = (
        ...
        .filter(EducationalRecordAccess.student_id == student_id)
