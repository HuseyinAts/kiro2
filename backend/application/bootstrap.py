import logging
from core.cqrs.bus import get_command_bus, get_query_bus
from application.commands.learning_path import (
    CreateStudentProfileCommand, CreateStudentProfileCommandHandler,
    AssessKnowledgeCommand, AssessKnowledgeCommandHandler,
    CreateLearningPathCommand, CreateLearningPathCommandHandler,
    SearchResourcesCommand, SearchResourcesCommandHandler,
    AdaptLearningPathCommand, AdaptLearningPathCommandHandler,
    UpdateCompletionStatusCommand, UpdateCompletionStatusCommandHandler,
    SubmitQuizCommand, SubmitQuizCommandHandler,
    UpdateProgressCommand, UpdateProgressCommandHandler,
    SubmitReviewCommand, SubmitReviewCommandHandler,
    RegisterWrongAnswersCommand, RegisterWrongAnswersCommandHandler
)
from application.commands.diary import (
    CreateSummaryCommand, CreateSummaryCommandHandler,
    UpdateSummaryCommand, UpdateSummaryCommandHandler,
    DeleteSummaryCommand, DeleteSummaryCommandHandler,
    CreateGoalCommand, CreateGoalCommandHandler,
    UpdateGoalCommand, UpdateGoalCommandHandler,
    UpdateGoalProgressCommand, UpdateGoalProgressCommandHandler,
    AdjustGoalCommand, AdjustGoalCommandHandler,
    ...
    DeleteInsightCommand, DeleteInsightCommandHandler,
    CreateReflectionCommand, CreateReflectionCommandHandler,
    CreateLearningEntryCommand, CreateLearningEntryCommandHandler,
    RecordReviewCommand, RecordReviewCommandHandler,
    LinkConceptsCommand, LinkConceptsCommandHandler,
    TrackEmotionalStateCommand, TrackEmotionalStateCommandHandler,
    CreateExportCommand, CreateExportCommandHandler,
    CreateShareLinkCommand, CreateShareLinkCommandHandler,
...
from application.commands.auth import (
    ...
    VeliOnayVerifyCommand, VeliOnayVerifyCommandHandler,
    VeliOnayWithdrawCommand, VeliOnayWithdrawCommandHandler
)
from application.commands.sinav import (
    CreateExamCommand, CreateExamCommandHandler,
    CreateBetaPracticeCommand, CreateBetaPracticeCommandHandler,
    StartExamCommand, StartExamCommandHandler,
    SaveAnswerCommand, SaveAnswerCommandHandler,
    NavigateQuestionCommand, NavigateQuestionCommandHandler,
    FlagQuestionCommand, FlagQuestionCommandHandler,
    CompleteExamCommand, CompleteExamCommandHandler,
    CancelExamCommand, CancelExamCommandHandler
)
...
def bootstrap_cqrs():
    ...
    # Register commands
    command_bus.register(CreateStudentProfileCommand, CreateStudentProfileCommandHandler())
    ...
    command_bus.register(UpdateCompletionStatusCommand, UpdateCompletionStatusCommandHandler())
    ...
    command_bus.register(RegisterWrongAnswersCommand, RegisterWrongAnswersCommandHandler())
    ...
    command_bus.register(CreateGoalRetrospectiveCommand, CreateGoalRetrospectiveCommandHandler())
    command_bus.register(DeleteGoalCommand, DeleteGoalCommandHandler())
    command_bus.register(AnalyzeEntriesForInsightsCommand, AnalyzeEntriesForInsightsCommandHandler())
    ...
    command_bus.register(CreateLearningEntryCommand, CreateLearningEntryCommandHandler())
    ...
    command_bus.register(TrackEmotionalStateCommand, TrackEmotionalStateCommandHandler())
    ...
    command_bus.register(CreateEncryptedBackupCommand, CreateEncryptedBackupCommandHandler())
