...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "goal_type", sa.String(length=20), nullable=False
        ...
        sa.Column(
            "status", sa.String(length=20), nullable=True, server_default="aktif"
    ...
    op.create_table(
        ...
        sa.Column(
            "notification_type", sa.String(length=20), nullable=False
