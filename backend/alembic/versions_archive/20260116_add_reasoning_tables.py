...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "model_name", sa.String(100), nullable=True, comment="Specific model used"
        ),
        sa.Column(
            "use_ensemble",
            sa.Boolean(),
        ...
        sa.Column(
            ...
            sa.Integer(),
            server_default="0",
            comment="Total reasoning steps",
        ),
        sa.Column(
            "latency_ms",
            sa.Float(),
            server_default="0.0",
            comment="Total latency in ms",
        ),
        sa.Column(
            "tokens_used", sa.Integer(), server_default="0", comment="Total tokens used"
        ),
        sa.Column(
            "cost_usd", sa.Float(), server_default="0.0", comment="Total cost in USD"
        ),
        sa.Column(
            "ensemble_scores",
            postgresql.JSON(),
    ...
    op.create_index(
        "idx_reasoning_sessions_provider", "reasoning_sessions", ["provider"]
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "confidence", sa.Float(), server_default="1.0", comment="Confidence 0-1"
        ),
        sa.Column(
            "is_verified",
            sa.Boolean(),
    ...
    op.create_table(
        ...
        sa.Column(
            "difficulty", sa.Float(), server_default="0.5", comment="Difficulty 0-1"
        ),
    ...
    op.create_index(
        "idx_sub_problems_order", "sub_problems", ["session_id", "order_index"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "problem_hash", sa.String(64), unique=True, nullable=False, index=True
        ),
