...
def upgrade() -> None:
    ...
    if not _table_exists("league_memberships"):
        op.create_table(
            ...
            sa.Column(
                "league_tier", sa.String(20), nullable=False, server_default="BRONZE"
            ),
    ...
    _safe_create_index(
        "idx_league_membership_student", "league_memberships", ["student_id"]
    )
    _safe_create_index(
        "idx_league_membership_tier_week",
        "league_memberships",
        ["league_tier", "week_start"],
    )
    _safe_create_index(
        "idx_league_membership_xp_rank",
        "league_memberships",
        ["league_tier", "week_start", "weekly_xp"],
    )
    _safe_create_unique_constraint(
        "uq_league_membership_student_week",
        "league_memberships",
    ...
    if not _table_exists("duel_sessions"):
        op.create_table(
            ...
            sa.Column("id", sa.String(), primary_key=True),
            sa.Column(
                "player1_id", sa.String(), sa.ForeignKey("users.id"), nullable=False
            ),
            sa.Column(
                "player2_id", sa.String(), sa.ForeignKey("users.id"), nullable=True
            ),
    ...
    if not _table_exists("duel_matches"):
        op.create_table(
            ...
            sa.Column(
                "session_id",
                sa.String(),
                sa.ForeignKey("duel_sessions.id", ondelete="CASCADE"),
                nullable=False,
            ),
    ...
    _safe_create_index(
        "idx_duel_match_order", "duel_matches", ["session_id", "question_order"]
    )
    ...
    _safe_create_index(
        "idx_duel_rating_student", "duel_ratings", ["student_id"], unique=True
    )
    ...
    if not _table_exists("study_plans"):
        op.create_table(
            ...
            sa.Column(
                "student_id", sa.String(), sa.ForeignKey("users.id"), nullable=False
            ),
    ...
    _safe_create_index(
        "idx_study_plans_active", "study_plans", ["student_id", "is_active"]
    )
    ...
    _safe_create_index(
        "idx_weekly_goals_week", "weekly_goals", ["plan_id", "week_number"]
    )
    ...
    _safe_create_index(
        "idx_coaching_shown", "coaching_events", ["student_id", "shown_at"]
    )
    ...
    _safe_create_index(
        "idx_engagement_student", "student_engagement_signals", ["student_id"]
    )
    _safe_create_index(
        "idx_engagement_type_recorded",
        "student_engagement_signals",
        ["student_id", "signal_type", "recorded_at"],
    )
    ...
    if not _table_exists("q_matrix"):
        op.create_table(
            ...
            sa.Column(
                "nano_skill_id",
                sa.String(),
                sa.ForeignKey("nano_skills.id", ondelete="CASCADE"),
                nullable=False,
            ),
    ...
    _safe_create_unique_constraint(
        "uq_qmatrix_pair", "q_matrix", ["question_id", "nano_skill_id"]
    )
    ...
    _safe_create_index(
        "idx_dina_question", "dina_parameters", ["question_id"], unique=True
    )
    ...
    _safe_create_index(
        "idx_snsm_skill", "student_nano_skill_mastery", ["nano_skill_id"]
    )
    _safe_create_unique_constraint(
        "uq_snsm_pair", "student_nano_skill_mastery", ["student_id", "nano_skill_id"]
    )
    ...
    _safe_create_index(
        "idx_qkm_question", "question_knowledge_mappings", ["question_id"]
    )
    _safe_create_index(
        "idx_qkm_knowledge_point", "question_knowledge_mappings", ["knowledge_point_id"]
    )
    _safe_create_unique_constraint(
        "uq_question_knowledge_mapping",
        "question_knowledge_mappings",
    ...
    _safe_create_index(
        "idx_sks_knowledge_point", "student_knowledge_states", ["knowledge_point_id"]
    )
    _safe_create_unique_constraint(
        "uq_student_knowledge_state",
        "student_knowledge_states",
