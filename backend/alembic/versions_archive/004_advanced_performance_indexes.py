...
def upgrade() -> None:
    ...
    if table_exists("sorular"):
        ...
        safe_create_index(
            "idx_sorular_sinav_zorluk_aktif",
            "sorular",
    ...
    if table_exists("sinav_sonuclari"):
        ...
        safe_create_index(
            "idx_sinav_sonuclari_ogrenci_tarih",
            "sinav_sonuclari",
    ...
    if table_exists("student_answers"):
        ...
        safe_create_index(
            "idx_student_answers_session_correct",
            "student_answers",
    ...
    if table_exists("learning_paths"):
        safe_create_index(
            "idx_learning_paths_student",
            "learning_paths",
            ["student_id"],
        )
        safe_create_index(
            "idx_learning_paths_subject",
            "learning_paths",
            ["student_id", "subject"],
        )
