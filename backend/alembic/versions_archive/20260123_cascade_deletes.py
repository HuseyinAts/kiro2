...
FK_UPDATES = [
    ...
    (
        ...
        "manipulative_activities_user_id_fkey",
        "user_id",
        "users",
        "id",
    ),
    (
        ...
        "manipulative_progress_user_id_fkey",
        "user_id",
        "users",
        "id",
    ),
    ...
    (
        ...
        "student_learning_profiles_student_id_fkey",
        "student_id",
        "users",
        "id",
    ),
...
def downgrade() -> None:
    ...
    for table_name, constraint_name, column_name, ref_table, ref_column in FK_UPDATES:
        ...
        op.create_foreign_key(
            constraint_name, table_name, ref_table, [column_name], [ref_column]
        )
