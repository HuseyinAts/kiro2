...
def upgrade() -> None:
    ...
    op.execute("ALTER TABLE question_bank ADD COLUMN IF NOT EXISTS image_ocr_text TEXT")
    op.execute("ALTER TABLE question_bank ADD COLUMN IF NOT EXISTS image_width INTEGER")
    op.execute(
