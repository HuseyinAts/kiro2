...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "device_info", sa.JSON(), nullable=True, comment="Device/browser info"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=50),
            nullable=False,
            comment="haftalik_calisma, sinav_hedefi, konu_tamamlama",
        ),
        ...
        sa.Column(
            ...
            default="aktif",
            nullable=False,
            comment="aktif, tamamlandi, iptal_edildi",
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=50),
            nullable=False,
            comment="bilgi, basari, uyari, hata",
        ),
        sa.Column(
            "action_url",
        ...
        sa.Column(
            ...
            sa.DateTime(timezone=True),
            nullable=True,
            comment="Auto-delete after this date",
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        "idx_notification_user_read", "notifications", ["user_id", "is_read"]
    )
    op.create_index("idx_notification_created_at", "notifications", ["created_at"])
    op.create_index(
        "idx_notification_priority", "notifications", ["user_id", "priority", "is_read"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "strong_subjects", postgresql.ARRAY(sa.String()), default=[], nullable=False
        ),
        sa.Column(
            "weak_subjects", postgresql.ARRAY(sa.String()), default=[], nullable=False
        ),
        ...
        sa.Column(
            "support_areas", postgresql.ARRAY(sa.String()), default=[], nullable=False
        ),
        # Metadata
        sa.Column(
            "created_at",
    ...
    op.create_index(
        "idx_parent_report_parent", "parent_reports", ["parent_user_id", "created_at"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            default="beklemede",
            nullable=False,
            comment="beklemede, onaylandi, reddedildi",
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        "idx_approval_parent_status", "parent_approvals", ["parent_user_id", "status"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=100),
            nullable=False,
            comment="Matematik, Türkçe, etc.",
        ),
        sa.Column(
            "grade_type",
            sa.String(length=50),
            nullable=False,
            comment="yazili, sözlü, proje, performans",
        ),
        sa.Column(
            "grade_value", sa.Float(), nullable=False, comment="0-100 or other scale"
        ),
        ...
        sa.Column(
            "academic_year", sa.String(length=20), nullable=False, comment="2024-2025"
        ),
    ...
    op.create_index(
        "idx_grade_student_subject", "student_grades", ["student_user_id", "subject"]
    )
    op.create_index("idx_grade_teacher", "student_grades", ["teacher_user_id"])
    op.create_index(
        "idx_grade_academic_year", "student_grades", ["academic_year", "semester"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.JSON(),
            nullable=True,
            comment='{"90-100": 5, "80-90": 10, ...}',
        ),
        sa.Column(
            "top_students", postgresql.ARRAY(sa.String()), default=[], nullable=False
        ),
        sa.Column(
            "struggling_students",
            postgresql.ARRAY(sa.String()),
        ...
        sa.Column(
            "recommendations", postgresql.ARRAY(sa.String()), default=[], nullable=False
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        "idx_class_report_teacher", "class_reports", ["teacher_user_id", "created_at"]
    )
