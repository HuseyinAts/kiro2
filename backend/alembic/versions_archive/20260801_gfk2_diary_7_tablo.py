...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "format",
            postgresql.ENUM(
                "MARKDOWN", "PDF", "JSON", name="exportformat", create_type=False
            ),
            nullable=False,
        ),
        ...
        sa.Column(
            "redacted_fields", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "adjustments", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "challenges_faced", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "start_date",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "concept_links", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "improvements", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "best_practices", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column("priority", sa.Integer(), nullable=True),
        sa.Column(
            "evidence_data", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("meta_data", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column(
            "depth",
            postgresql.ENUM(
                "SURFACE", "MODERATE", "DEEP", name="reflectiondepth", create_type=False
            ),
            nullable=True,
        ),
        ...
        sa.Column(
            "action_items", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("meta_data", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column(
            "created_at",
