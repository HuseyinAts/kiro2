...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("comment", sa.Text(), nullable=True, comment="User comment"),
        # Implicit feedback
        sa.Column(
            "retry_count", sa.Integer(), server_default="0", comment="Retry count"
        ),
        sa.Column(
            "edit_frequency", sa.Integer(), server_default="0", comment="Edit frequency"
        ),
        sa.Column(
            "execution_time",
            sa.Float(),
        ...
        sa.Column("test_passed", sa.Boolean(), nullable=True, comment="Test result"),
        sa.Column("lint_passed", sa.Boolean(), nullable=True, comment="Lint result"),
        sa.Column(
            "type_check_passed",
            sa.Boolean(),
            nullable=True,
        ...
        sa.Column("agent_type", sa.String(100), nullable=True, comment="Agent type"),
        sa.Column(
            "context",
            postgresql.JSONB(),
            server_default="{}",
    ...
    op.create_table(
        ...
        sa.Column("rule_text", sa.Text(), nullable=True, comment="Rule text"),
        sa.Column(
            "section", sa.String(255), nullable=True, comment="CLAUDE.md section"
        ),
        # Metrikler
        sa.Column(
            "total_feedback",
        ...
        sa.Column(
            "success_count", sa.Integer(), server_default="0", comment="Success count"
        ),
        sa.Column(
            "failure_count", sa.Integer(), server_default="0", comment="Failure count"
        ),
        # Hesaplanan skorlar
        sa.Column(
            "effectiveness_score",
        ...
        sa.Column(
            "confidence", sa.Float(), server_default="0.0", comment="Confidence level"
        ),
        # Ağırlıklı skorlar
        sa.Column(
            "explicit_score",
    ...
    op.create_table(
        ...
        sa.Column(
            "trigger_reason", sa.Text(), nullable=False, comment="Trigger reason"
        ),
        # Threshold bilgileri
        sa.Column(
            "current_score",
        ...
        sa.Column(
            "threshold", sa.Float(), server_default="0.6", comment="Trigger threshold"
        ),
        sa.Column(
            "improvement_target",
            sa.Float(),
        ...
        sa.Column("priority", sa.Integer(), server_default="1", comment="Priority 1-5"),
        # Durum
        sa.Column(
            "triggered_at",
            sa.DateTime(),
        ...
        sa.Column(
            "processed", sa.Boolean(), server_default="false", comment="Is processed"
        ),
        sa.Column(
            "processed_at", sa.DateTime(), nullable=True, comment="Processing timestamp"
        ),
        # Onay workflow
        sa.Column("approved", sa.Boolean(), nullable=True, comment="Is approved"),
        sa.Column("approved_by", sa.String(255), nullable=True, comment="Approved by"),
        # Uygulama
        sa.Column(
            "applied", sa.Boolean(), server_default="false", comment="Is applied"
        ),
        sa.Column(
            "applied_at", sa.DateTime(), nullable=True, comment="Application timestamp"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "description", sa.Text(), nullable=False, comment="Pattern description"
        ),
        # İstatistikler
        sa.Column(
            "occurrence_count",
        ...
        sa.Column("recommendation", sa.Text(), nullable=True, comment="Recommendation"),
        # Timestamps
        sa.Column(
            "detected_at",
            sa.DateTime(),
        ...
        sa.Column("active", sa.Boolean(), server_default="true", comment="Is active"),
    )
    ...
    op.create_table(
        ...
        sa.Column("version", sa.String(50), nullable=False, comment="Semantic version"),
        sa.Column("rule_text", sa.Text(), nullable=False, comment="Rule text"),
        sa.Column("change_reason", sa.Text(), nullable=True, comment="Change reason"),
        # Version tracking
        sa.Column(
            "previous_version_id",
            postgresql.UUID(as_uuid=True),
        ...
        # Metadata
        sa.Column(
            "created_by", sa.String(255), nullable=True, comment="Created by agent/user"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(),
    ...
    op.create_index(
        "ix_rule_current", "claude_md_rule_versions", ["rule_id", "is_current"]
    )
    ...
    op.create_table(
        ...
        sa.Column("entity_id", sa.String(255), nullable=True, comment="Entity ID"),
        sa.Column("actor", sa.String(255), nullable=True, comment="Actor (agent/user)"),
        sa.Column("reason", sa.Text(), nullable=True, comment="Reason"),
        sa.Column(
            "details", postgresql.JSONB(), server_default="{}", comment="Details"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(),
    ...
    op.create_index(
        "ix_audit_entity", "claude_md_audit_logs", ["entity_type", "entity_id"]
    )
    op.create_index(
        "ix_audit_action_time", "claude_md_audit_logs", ["action", "created_at"]
    )
