...
def upgrade() -> None:
    ...
    op.execute("CREATE INDEX IF NOT EXISTS idx_insights_user ON insights (user_id);")
    op.execute(
    ...
    op.execute("CREATE INDEX IF NOT EXISTS idx_goals_user ON goals (user_id);")
    op.execute("CREATE INDEX IF NOT EXISTS idx_goals_status ON goals (status);")
    op.execute(
        "CREATE INDEX IF NOT EXISTS idx_goals_target_date " "ON goals (target_date);"
    )
    op.execute("CREATE INDEX IF NOT EXISTS idx_goals_at_risk ON goals (is_at_risk);")
