...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "reasoning_data", sa.JSON(), nullable=False, comment="Full reasoning result"
        ),
        sa.Column("provider", sa.String(length=50), nullable=True),
        sa.Column(
            "hit_count", sa.Integer(), nullable=True, comment="Number of cache hits"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "watched_segments", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "trigger_factors", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "zoom_meeting_data", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "meet_event_data", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
