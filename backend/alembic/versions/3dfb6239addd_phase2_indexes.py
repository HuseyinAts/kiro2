...
def upgrade() -> None:
    op.create_index('idx_user_email_phase2', 'users', ['email'], unique=False, if_not_exists=True)
    op.create_index('idx_user_username_phase2', 'users', ['username'], unique=False, if_not_exists=True)
