...
def upgrade() -> None:
    ...
    op.create_index(
        ...
        unique=False,
        postgresql_where=sa.text('is_active = true')  # Partial index for active content
    )
...
def downgrade() -> None:
    ...
    op.drop_index('idx_tag_association_question', table_name='question_tag_associations')
