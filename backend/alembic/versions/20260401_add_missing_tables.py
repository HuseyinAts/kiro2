...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("quest_date", "student_id", "quest_type", name="uq_daily_quest"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "student_id", sa.String(100),
            sa.ForeignKey("learning_path_student_profiles.student_id", ondelete="CASCADE"),
            nullable=False,
        ),
        ...
        sa.Column("topics_studied", sa.JSON(), nullable=True,
                  server_default=sa.text("'[]'::json")),
        sa.Column("questions_answered", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("correct_count", sa.Integer(), nullable=False, server_default="0"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index("idx_session_student_started", "study_sessions",
