...
def upgrade():
    ...
    op.create_table("university_programs",
        sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("university_id", UUID(as_uuid=True), sa.ForeignKey("universities.id"), nullable=False),
    ...
    op.create_index("idx_program_search", "university_programs", ["university_id", "department_id", "year", "score_type"])
    op.create_index("idx_base_score", "university_programs", ["year", "score_type", "base_score"])

    op.create_table("program_score_history",
        sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("program_id", UUID(as_uuid=True), sa.ForeignKey("university_programs.id"), nullable=False),
        sa.Column("year", sa.Integer, nullable=False),
        sa.Column("base_score", sa.Float), sa.Column("top_score", sa.Float),
        sa.Column("median_score", sa.Float),
        sa.Column("total_quota", sa.Integer), sa.Column("filled_quota", sa.Integer),
        sa.Column("min_rank", sa.Integer), sa.Column("max_rank", sa.Integer),
    ...
    op.create_table("user_university_preferences",
        ...
        sa.Column("yks_score", sa.Float), sa.Column("score_type", sa.String(10)),
    ...
    op.create_table("campus_info",
        ...
        sa.Column("city", sa.String(100), nullable=False),
        sa.Column("district", sa.String(100)), sa.Column("address", sa.Text),
        sa.Column("total_area_sqm", sa.Integer), sa.Column("building_count", sa.Integer),
        sa.Column("libraries", JSONB), sa.Column("sports_facilities", ARRAY(sa.String)),
        sa.Column("laboratories", JSONB), sa.Column("dining_facilities", JSONB),
        ...
        sa.Column("student_clubs", JSONB), sa.Column("total_student_clubs", sa.Integer, default=0),
        ...
        sa.Column("description", sa.Text), sa.Column("highlights", ARRAY(sa.String)),
        sa.Column("photos", ARRAY(sa.String)),
        sa.Column("phone", sa.String(50)), sa.Column("email", sa.String(255)), sa.Column("website", sa.String(255)),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
    )
    ...
    op.create_table("city_living_costs",
        ...
        sa.Column("rent_studio_avg", sa.Integer), sa.Column("rent_1br_avg", sa.Integer),
        sa.Column("shared_room_avg", sa.Integer), sa.Column("utilities_avg", sa.Integer),
        sa.Column("food_budget_avg", sa.Integer), sa.Column("public_transport_monthly", sa.Integer),
        sa.Column("total_min_budget", sa.Integer), sa.Column("total_avg_budget", sa.Integer),
        ...
        sa.Column("data_source", sa.String(255)), sa.Column("notes", sa.Text),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
    )
    ...
    op.create_table("dormitory_info",
        sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("university_id", UUID(as_uuid=True), sa.ForeignKey("universities.id", ondelete="CASCADE")),
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column("accommodation_type", sa.String(30), nullable=False),
        sa.Column("city", sa.String(100), nullable=False),
        sa.Column("district", sa.String(100)), sa.Column("address", sa.Text),
        sa.Column("total_capacity", sa.Integer), sa.Column("available_spaces", sa.Integer),
        sa.Column("gender", sa.String(20)),
        sa.Column("room_types", JSONB),
        sa.Column("price_min", sa.Integer), sa.Column("price_max", sa.Integer), sa.Column("price_avg", sa.Integer),
        ...
        sa.Column("description", sa.Text), sa.Column("photos", ARRAY(sa.String)),
        sa.Column("phone", sa.String(50)), sa.Column("email", sa.String(255)), sa.Column("website", sa.String(255)),
    ...
    op.create_table("scholarship_programs",
        ...
        sa.Column("amount_min", sa.Integer), sa.Column("amount_max", sa.Integer),
        sa.Column("monthly_stipend", sa.Integer),
        sa.Column("min_exam_score", sa.Float), sa.Column("min_high_school_gpa", sa.Float),
    ...
    op.create_table("university_statistics",
        ...
        sa.Column("avg_monthly_cost", sa.Integer), sa.Column("avg_rent", sa.Integer),
        sa.Column("cost_of_living_index", sa.Float),
    ...
    op.create_table("department_curricula",
        ...
        sa.Column("core_courses", JSONB), sa.Column("elective_courses", JSONB),
    ...
    op.create_table("salary_expectations",
        sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("department_id", UUID(as_uuid=True), sa.ForeignKey("departments.id"), nullable=False),
        sa.Column("career_opportunity_id", UUID(as_uuid=True), sa.ForeignKey("career_opportunities.id")),
        ...
        sa.Column("region", sa.String(50)), sa.Column("city", sa.String(100)),
        sa.Column("industry_type", sa.String(30)),
        sa.Column("year", sa.Integer, nullable=False, default=2024),
    ...
    op.create_table("sector_analyses",
        ...
        sa.Column("year", sa.Integer, nullable=False, default=2024),
        sa.Column("annual_growth_rate", sa.Float), sa.Column("job_growth_rate", sa.Float),
    ...
    op.create_table("department_statistics",
        sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("department_id", UUID(as_uuid=True), sa.ForeignKey("departments.id"), nullable=False, unique=True),
        ...
        sa.Column("top_industries", JSONB), sa.Column("top_job_titles", JSONB),
    ...
    op.create_table("student_reviews",
        ...
        sa.Column("university_id", UUID(as_uuid=True), sa.ForeignKey("universities.id", ondelete="CASCADE")),
        sa.Column("department_id", UUID(as_uuid=True), sa.ForeignKey("departments.id", ondelete="CASCADE")),
        sa.Column("dormitory_id", UUID(as_uuid=True), sa.ForeignKey("dormitory_info.id", ondelete="CASCADE")),
        ...
        sa.Column("moderated_by", sa.String, sa.ForeignKey("users.id", ondelete="SET NULL")),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
    )
    ...
    op.create_table("review_ratings",
        sa.Column("id", UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("review_id", UUID(as_uuid=True), sa.ForeignKey("student_reviews.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table("moderation_queue",
        ...
        sa.Column("status", sa.String(20), default="pending"),
        sa.Column("moderator_id", sa.String, sa.ForeignKey("users.id", ondelete="SET NULL")),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
...
def downgrade():
    for t in ["moderation_queue", "review_statistics", "review_reports", "review_votes",
              "review_ratings", "student_reviews", "department_statistics", "sector_analyses",
              "salary_expectations", "career_opportunities", "department_curricula",
              "university_statistics", "scholarship_programs", "dormitory_info",
              "city_living_costs", "campus_info", "user_university_preferences",
              "program_score_history", "university_programs", "departments", "universities"]:
        op.drop_table(t)
