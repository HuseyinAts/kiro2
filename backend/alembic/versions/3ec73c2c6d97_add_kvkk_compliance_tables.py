...
def upgrade() -> None:
    ...
    op.create_index('idx_kvkk_policy_version', 'kvkk_privacy_policy_versions', ['version'])
    op.create_index('idx_kvkk_policy_active', 'kvkk_privacy_policy_versions', ['is_active'])
    ...
    op.create_table(
        ...
        sa.Column('deletion_type', sa.String(50), nullable=False, server_default='full'),
        sa.Column('data_categories', JSON, nullable=True),
    ...
    op.create_index('idx_kvkk_deletion_user_id', 'kvkk_data_deletion_requests', ['user_id'])
    op.create_index('idx_kvkk_deletion_status', 'kvkk_data_deletion_requests', ['status'])
