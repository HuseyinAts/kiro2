...
class ExamResultsReportGenerator:
    ...
    async def _analyze_subject_difficulty(
        ...
        try:
            ...
            # Simulate difficulty distribution (typical Turkish exam distribution)
            easy_questions = int(total_questions * 0.4)  # 40% easy
            medium_questions = int(total_questions * 0.4)  # 40% medium
            hard_questions = (
                total_questions - easy_questions - medium_questions
            )  # 20% hard

            # Simulate performance based on overall success rate
    ...
    async def _generate_performance_analysis(self, report: ExamResultReport):
        ...
        try:
            ...
            trends_analysis = {
                ...
                "score_trend": "stable",  # Mock data
                "subject_trends": {},
                "improvement_rate": 0.05,  # Mock 5% improvement
    ...
    async def _add_comparison_data(self, report: ExamResultReport):
        ...
        try:
            ...
            # Mock historical comparison (would use actual historical data)
            report.historical_comparison = {
                "previous_exams": [
                    {
                        "date": "15.01.2024",
                        "score": float(report.exam_metrics.score) - 15,
                        "improvement": "+15 puan gelişim",
                    }
                ],
                "best_performance": {
                ...
                "improvement_rate": "+12% son 30 günde",
            }
