...
|---------|-----------|----------|----------|-------|-----|
| J10–J13 Chroma | `api.v1.semantic_search`, clustering, recommendation, duplicate | TBD | — | **Sarı** | `chromadb` minimal image’a eklendi; `vector_db` Docker volume; ingest/smoke sırada |
