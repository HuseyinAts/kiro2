# KIRO2 — P0 Golden paketi (J1+J3+J4+K4): önce :8000 health, sonra 9 test
# (GF1x/GF3d: J1 çıkış + J4 complete; GF6w: admin soru; GF1w/GF3w: BKT/regresyon; CI ile aynı liste).
...
Write-Host "=== P0 Golden (9 test) -> $BackendUrl ===" -ForegroundColor Cyan
try {
...
# P0 (CI backend-test ile aynı 9 test)
python -m pytest `
